<template>
	<form id="modal-create" class="modal fade" method="post" autocomplete="off" v-on:submit.prevent="create()">
					...
					<div class="row">
						<div class="col">
							...
							<div class="form-group">
								...
								<input type="text" name="name" v-model="terjual" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
